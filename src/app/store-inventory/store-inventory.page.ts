...
@Component({
  ...
  templateUrl: './store-inventory.page.html',
  styleUrls: ['./store-inventory.page.scss'],
})
export class StoreInventoryPage implements OnInit {
  itemName: string = '';
  itemCategory: string = '';
  ...
  constructor(
    ...
    private toastController: ToastController, // Changed variable name to toastController
